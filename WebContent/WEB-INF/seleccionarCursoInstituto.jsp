...
<t:plantilla>
    <jsp:body>
         <h4>Seleccionar Curso ${instituto.getNombre()}</h4>
         <hr />
         <br />
        <div class="form-group table-responsive">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
              	...
              	<c:if test="${not empty instituto.getCursos()}">
					<c:forEach items="${instituto.getCursos()}" var="curso" >                       
		              <tr>
				...
				<c:if test="${empty instituto.getCursos()}">
		              <tr>
		                <td>No hay cursos...</td>
		                <td></td>		                
		              </tr>
