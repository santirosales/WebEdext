...
<t:plantilla>
    <jsp:body>
    	 <h4>Ingresar Resultados Edición de Curso</h4>
         <hr />
         <br />
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-md-6">
                  <div class="card">
                    <div class="card-body">                  
                      <div class="table-responsive"><strong>Ingrese la nota para los estudiantes</strong></div>
						...
						<c:if test="${not empty edicion.inscripciones}">
							<c:forEach items="${edicion.inscripciones}" var="ins" >
					            <tr>
									  ...
									  <td>${ins.estado}</td>
					                  <td>
									  <select class='form-control form-control-sm inscripcionNota' name='listaNotas'>
							  			  <option></option>
							  			  <option ${ins.nota == 1 ? 'selected' : ''}>1</option>
							  			  <option ${ins.nota == 2 ? 'selected' : ''}>2</option>						  			  
							  			  <option ${ins.nota == 3 ? 'selected' : ''}>3</option>
							  			  <option ${ins.nota == 4 ? 'selected' : ''}>4</option>						  			  
							  			  <option ${ins.nota == 5 ? 'selected' : ''}>5</option>
							  			  <option ${ins.nota == 6 ? 'selected' : ''}>6</option>						  			  
							  			  <option ${ins.nota == 7 ? 'selected' : ''}>7</option>
							  			  <option ${ins.nota == 8 ? 'selected' : ''}>8</option>						  			  
							  			  <option ${ins.nota == 9 ? 'selected' : ''}>9</option>
							  			  <option ${ins.nota == 10 ? 'selected' : ''}>10</option>						  			  
							  			  <option ${ins.nota == 11 ? 'selected' : ''}>11</option>
							  			  <option ${ins.nota == 12 ? 'selected' : ''}>12</option>						  			  
									  </select>
					                  </td>									  
								</tr>
							</c:forEach>
		           ...
		           <div id=sinFinalizar>
			           <div class="form-group row">
			             <label class="control-label col-sm-4" for="cerrarEdicion">Cerrar la edición:</label>
			             <input type="checkbox" class="form-control" name="cerrarEdicion" id="cerrarEdicion" value="" style="width:15px;">
			           </div>
			           <div class="form-group row">
			             <div class="col-sm-offset-2 col-sm-10">
			               <button type="submit" class="btn btn-info">Confirmar resultados</button>
			             </div>
			           </div>		   
		           </div>                                   
                </div>
				...
				$.getJSON('JsonCursoEdicionVigenteResultados', { 'curso': curso }, function(data) {
					...
					if(data) {
						...
						$.each(data.inscripciones, function(indice, inscripcion) {
							...
							"<td><select class='form-control form-control-sm inscripcionEstado' name='listaNotas'" + (data.finalizada ? " disabled" : "") + " data-nick=" + inscripcion.estudiante.nickname + ">" +
							"  <option></option>" + 
							"  <option " + (inscripcion.nota == 1 ? 'selected' : '') + ">1</option>" + 
							"  <option " + (inscripcion.nota == 2 ? 'selected' : '') + ">2</option>" + 
							"  <option " + (inscripcion.nota == 3 ? 'selected' : '') + ">3</option>" + 
							"  <option " + (inscripcion.nota == 4 ? 'selected' : '') + ">4</option>" + 
							"  <option " + (inscripcion.nota == 5 ? 'selected' : '') + ">5</option>" + 
							"  <option " + (inscripcion.nota == 6 ? 'selected' : '') + ">6</option>" + 
							"  <option " + (inscripcion.nota == 7 ? 'selected' : '') + ">7</option>" + 
							"  <option " + (inscripcion.nota == 8 ? 'selected' : '') + ">8</option>" + 
							"  <option " + (inscripcion.nota == 9 ? 'selected' : '') + ">9</option>" + 
							"  <option " + (inscripcion.nota == 10 ? 'selected' : '') + ">10</option>" + 
							"  <option " + (inscripcion.nota == 11 ? 'selected' : '') + ">11</option>" + 
							"  <option " + (inscripcion.nota == 12 ? 'selected' : '') + ">12</option>" + 
							"</select></td>";
