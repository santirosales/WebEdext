...
<t:plantilla>
    <jsp:body>
         <h4>Seleccionar Curso ${categoria.getNombre()}</h4>
         <hr />
         <br />
        <div class="form-group table-responsive">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
				...
				<c:if test="${not empty categoria.getCursos()}">
					<c:forEach items="${categoria.getCursos()}" var="curso" >                       
		              <tr>
				...
				<c:if test="${empty categoria.getCursos()}">
		              <tr>
		                <td>No hay cursos...</td>
		                <td></td>
		              </tr>
