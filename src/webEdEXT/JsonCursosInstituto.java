...
/**
 * Servlet implementation class JsonCursosInstituto
 */
@WebServlet("/JsonCursosInstituto")
public class JsonCursosInstituto extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JsonCursosInstituto() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (instituto != null && !instituto.isEmpty()) {
			...
			List<DtInfoCurso> cursos = ws.listarCursosInstituto(instituto).getLista();
			//Gson gson = new Gson();
			//Gson gson = new Gson();
