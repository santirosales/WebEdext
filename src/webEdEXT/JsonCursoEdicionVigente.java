...
/**
 * Servlet implementation class JsonCursoEdicionVigente
 */
@WebServlet("/JsonCursoEdicionVigente")
public class JsonCursoEdicionVigente extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JsonCursoEdicionVigente() {
        super();
